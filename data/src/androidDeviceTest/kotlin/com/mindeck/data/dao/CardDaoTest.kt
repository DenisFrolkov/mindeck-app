...
class CardDaoTest {
    ...
    @Test
    fun insertCard_and_getCardById_returns_inserted_card() =
        runTest {
    ...
    @Test
    fun getCardsRepetition_returns_card_with_NEW_state() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
    ...
    @Test
    fun getCardsRepetition_returns_card_with_REVIEW_state_and_past_nextReviewDate() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
    ...
    @Test
    fun getCardsRepetition_does_not_return_card_with_future_nextReviewDate() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
    ...
    @Test
    fun getCardsRepetition_returns_card_with_firstReviewDate_today() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
    ...
    @Test
    fun getCardsRepetition_does_not_return_card_with_firstReviewDate_yesterday() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
            ...
            val card =
                CardEntity(
                    ...
                    cardType = CardType.SIMPLE.stableId,
                    cardState = "REVIEW",
                    firstReviewDate = todayStart - dayMs,
                    nextReviewDate = now + dayMs,
                    cardTag = "",
                    deckId = 1,
                )
    ...
    @Test
    fun deleteDeck_cascadeDeletes_allCardsInDeck() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
    ...
    @Test
    fun updateCard_updatesFields_and_getCardById_returnsUpdated() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
            ...
            val updateCard = card.copy(cardState = "LEARNING", easeFactor = 3f, interval = 2f, nextReviewDate = now + dayMs * 4)
    ...
    @Test
    fun deleteCard_removesCard_and_getCardById_returnsNull() =
        runTest {
            val deck = DeckEntity(deckId = 1, deckName = "Test Deck")
            deckDao.insertDeck(deck)
    ...
    @Test
    fun getAllCardsByDeckId_returnsOnly_cardsFromRequestedDeck() =
        runTest {
    ...
    @Test
    fun getCardWithDeckById_returnsCardWithCorrectDeck() =
        runTest {
