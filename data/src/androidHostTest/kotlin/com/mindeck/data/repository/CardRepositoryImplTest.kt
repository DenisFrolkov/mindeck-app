...
class CardRepositoryImplTest {
    ...
    @Test
    fun `insertCard calls dao with correct arguments`() =
        runTest {
    ...
    fun `insertCard throws NameAlreadyExists when dao throws SQLiteConstraintException`() =
        runTest {
            coEvery { cardDao.insertCard(any()) } throws Exception("UNIQUE constraint failed: card.card_name")
            repository.insertCard(card)
        }

    @Test(expected = DomainError.DatabaseError::class)
    fun `insertCard throws DatabaseError when dao throws Exception`() =
        runTest {
    ...
    @Test
    fun `updateCard calls dao with correct arguments`() =
        runTest {
    ...
    @Test(expected = DomainError.NameAlreadyExists::class)
    fun `updateCard throws NameAlreadyExists when dao throws SQLiteConstraintException`() =
        runTest {
            coEvery { cardDao.updateCard(any()) } throws Exception("UNIQUE constraint failed: card.card_name")
            repository.updateCard(card)
        }

    @Test(expected = DomainError.DatabaseError::class)
    fun `updateCard throws DatabaseError when dao throws Exception`() =
        runTest {
    ...
    @Test
    fun `deleteCard calls dao with correct arguments`() =
        runTest {
    ...
    @Test(expected = DomainError.DatabaseError::class)
    fun `deleteCard throws DatabaseError when dao throws Exception`() =
        runTest {
    ...
    @Test
    fun `getAllCardsByDeckId emits mapped card list when dao returns entities`() =
        runTest {
    ...
    @Test
    fun `getAllCardsByDeckId emits DatabaseError when dao flow throws Exception`() =
        runTest {
    ...
    @Test
    fun `getCardById emits mapped card when dao returns entity`() =
        runTest {
            val cardEntity = card.toEntity()
    ...
    @Test
    fun `getCardById emits DatabaseError when dao flow throws Exception`() =
        runTest {
    ...
    @Test
    fun `getCardWithDeckById emits mapped card with deck when dao returns entity`() =
        runTest {
    ...
    @Test
    fun `getCardWithDeckById emits DatabaseError when dao flow throws Exception`() =
        runTest {
