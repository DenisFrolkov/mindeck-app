...
class DeckViewModelTest {
    ...
    @Test
    fun screenUiState_returnsSuccess_whenDeckAndCardsLoaded() =
        runTest {
    ...
    @Test
    fun screenUiState_returnsError_whenDeckIsNull() =
        runTest {
    ...
    @Test
    fun screenUiState_returnsError_whenFlowThrowsDatabaseError() =
        runTest {
    ...
    @Test
    fun renameDeck_success_updatesStateAndClosesModal() =
        runTest {
    ...
    @Test
    fun renameDeck_error_nameAlreadyExists() =
        runTest {
    ...
    @Test
    fun renameDeck_error_databaseError() =
        runTest {
    ...
    @Test
    fun deleteDeck_success_emitsGoBackAndShowToast() =
        runTest {
    ...
    @Test
    fun deleteDeck_error_domainError() =
        runTest {
    ...
    @Test
    fun deleteDeck_error_exception() =
        runTest {
