...
class CardViewModelTest {
    ...
    private fun createViewModel(): CardViewModel =
        CardViewModel(
    ...
    @Test
    fun cardWithDeck_returnsSuccess_whenCardLoaded() =
        runTest {
    ...
    @Test
    fun cardWithDeck_returnsError_whenCardIsNull() =
        runTest {
    ...
    @Test
    fun cardWithDeck_returnsError_whenFlowThrowsDatabaseError() =
        runTest {
    ...
    @Test
    fun deleteCard_success_updatesStateClosesModalAndEmitsEvent() =
        runTest {
    ...
    @Test
    fun deleteCard_databaseError_emitsError() =
        runTest {
    ...
    @Test
    fun deleteCard_domainError_emitsError() =
        runTest {
